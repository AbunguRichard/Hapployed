...
export default function PostProjectPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 relative">
      ...
      <div className="absolute bottom-40 left-20 w-96 h-96 bg-accent/5 rounded-full blur-3xl pointer-events-none" />

      <DashboardNav />

      <main className="container mx-auto px-4 md:px-6 lg:px-8 py-8 max-w-4xl relative z-10">
        {/* Header */}
        <div className="mb-8">
        ...
        {/* To-Go Banner */}
        {!showToGo && (
          <div className="mb-6 p-4 bg-accent/10 border border-accent/30 rounded-xl flex items-center justify-between">
